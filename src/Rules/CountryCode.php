...
final class CountryCode implements ValidationRule
{
     ...
     */
    public const array ALPHA_2_CODES = [
    ...
    /**
     * Complete list of ISO 3166-1 alpha-3 country codes.
     *
     * @var array<int, string>
     */
    public const array ALPHA_3_CODES = [
    ...
    public function __construct(
        public readonly string $format = 'alpha2',
    ) {}

    /**
     * Create a new rule instance.
     */
    public static function make(string $format = 'alpha2'): static
    {
    ...
    {
        if (! is_string($value)) {
            $fail('laravel-extended-validation::validation.country_code')->translate();
